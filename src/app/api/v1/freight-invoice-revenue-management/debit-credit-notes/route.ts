...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "debit-credit-notes", entityId: created?.id, module: "freight-invoice-revenue-management", newData: created as Record<string, unknown>, request });
