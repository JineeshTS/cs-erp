...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "visa-travel-records", entityId: created.id, module: "crew-management", newData: created as Record<string, unknown>, request });
