...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "tc-settlements", entityId: record?.id, module: "voyage-results-settlement", newData: record as Record<string, unknown>, request });
