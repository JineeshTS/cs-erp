...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "change-requests", entityId: record?.id, module: "implementation-change-management", newData: record as Record<string, unknown>, request });
