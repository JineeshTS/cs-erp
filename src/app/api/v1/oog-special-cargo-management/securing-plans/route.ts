...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "securing-plans", entityId: created?.id, module: "oog-special-cargo-management", newData: created as Record<string, unknown>, request });
