...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "predictive-maintenance", entityId: created?.id, module: "vessel-technical-management", newData: created as Record<string, unknown>, request });
