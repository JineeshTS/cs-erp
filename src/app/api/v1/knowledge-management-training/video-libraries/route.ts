...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "video-libraries", entityId: record?.id, module: "knowledge-management-training", newData: record as Record<string, unknown>, request });
