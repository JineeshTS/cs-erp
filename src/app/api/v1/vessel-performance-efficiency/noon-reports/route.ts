...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "noon-reports", entityId: record?.id, module: "vessel-performance-efficiency", newData: record as Record<string, unknown>, request });
