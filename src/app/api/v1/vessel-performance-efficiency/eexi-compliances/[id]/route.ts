...
export async function PATCH(
  ...
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "update", entityType: "eexi-compliances", entityId: record?.id, module: "vessel-performance-efficiency", previousData: null, newData: record as Record<string, unknown>, request });
...
export async function DELETE(
  ...
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "delete", entityType: "eexi-compliances", entityId: record?.id, module: "vessel-performance-efficiency", previousData: null, request });
