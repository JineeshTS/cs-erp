...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "environmental-incidents", entityId: record?.id, module: "marpol-environmental-compliance", newData: record as Record<string, unknown>, request });
