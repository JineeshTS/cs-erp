...
import { createCostTrackingSchema } from "@/lib/empty-container-repositioning-ai/validation";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await listCostTrackings({
    ...
    console.error("Failed to list cost trackings:", error);
