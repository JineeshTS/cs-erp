...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "vendor-masters", entityId: created?.id, module: "accounts-payable-vendor-management", newData: created as Record<string, unknown>, request });
