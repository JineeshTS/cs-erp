...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "update", entityType: "account-plans", entityId: updated.id, module: "sales-crm", previousData: null, newData: updated as Record<string, unknown>, request });
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "delete", entityType: "account-plans", entityId: deleted.id, module: "sales-crm", previousData: null, request });
