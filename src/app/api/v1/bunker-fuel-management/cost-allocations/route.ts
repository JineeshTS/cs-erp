...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "cost-allocations", entityId: created?.id, module: "bunker-fuel-management", newData: created as Record<string, unknown>, request });
