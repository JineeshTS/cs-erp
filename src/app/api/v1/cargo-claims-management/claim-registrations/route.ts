...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "claim-registrations", entityId: record?.id, module: "cargo-claims-management", newData: record as Record<string, unknown>, request });
