  ...
  try {
    ...
    const [
      ...
      db.select({ value: count() }).from(anmSubAgentConfigs)
        ...
        .then(([r]) => r.value),
      db.select({ value: count() }).from(anmAgentCommissions)
        ...
        .then(([r]) => r.value),
      db.select({ value: count() }).from(anmAgencyDocuments)
        ...
        .then(([r]) => r.value),
      db.select({ value: count() }).from(anmPerformanceKpis)
      ...
      db.select({ value: count() }).from(anmBookingAuthorities)
        ...
        .then(([r]) => r.value),
      db.select({ value: count() }).from(anmAgentIncentives)
