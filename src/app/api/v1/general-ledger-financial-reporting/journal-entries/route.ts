...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "journal-entries", entityId: record?.id, module: "general-ledger-financial-reporting", newData: record as Record<string, unknown>, request });
