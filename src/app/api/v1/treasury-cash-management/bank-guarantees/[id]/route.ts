...
export async function PATCH(
  ...
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "update", entityType: "bank-guarantees", entityId: record?.id, module: "treasury-cash-management", previousData: null, newData: record as Record<string, unknown>, request });
...
export async function DELETE(
  ...
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "delete", entityType: "bank-guarantees", entityId: record?.id, module: "treasury-cash-management", previousData: null, request });
