...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "cash-pooling-sweeps", entityId: record.id, module: "treasury-cash-management", newData: record as Record<string, unknown>, request });
