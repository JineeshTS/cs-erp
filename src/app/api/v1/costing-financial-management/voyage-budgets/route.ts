...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "voyage-budgets", entityId: created?.id, module: "costing-financial-management", newData: created as Record<string, unknown>, request });
