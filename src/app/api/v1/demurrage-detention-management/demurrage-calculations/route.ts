...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "demurrage-calculations", entityId: created?.id, module: "demurrage-detention-management", newData: created as Record<string, unknown>, request });
