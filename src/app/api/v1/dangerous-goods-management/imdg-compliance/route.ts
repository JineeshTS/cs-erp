...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "imdg-compliance", entityId: created?.id, module: "dangerous-goods-management", newData: created as Record<string, unknown>, request });
