...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "impairment-tests", entityId: record?.id, module: "fixed-assets-management", newData: record as Record<string, unknown>, request });
