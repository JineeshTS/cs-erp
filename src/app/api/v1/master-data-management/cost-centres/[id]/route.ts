...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "update", entityType: "cost-centres", entityId: updated?.id, module: "master-data-management", previousData: null, newData: updated as Record<string, unknown>, request });
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "delete", entityType: "cost-centres", entityId: deleted?.id, module: "master-data-management", previousData: null, request });
