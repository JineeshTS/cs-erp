...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "risk-kpi-dashboards", entityId: record.id, module: "loss-prevention-risk-management", newData: record as Record<string, unknown>, request });
