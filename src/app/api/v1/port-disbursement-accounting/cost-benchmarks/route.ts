...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "cost-benchmarks", entityId: created?.id, module: "port-disbursement-accounting", newData: created as Record<string, unknown>, request });
