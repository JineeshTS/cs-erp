...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "claim-analytics", entityId: created.id, module: "reefer-container-management", newData: created as Record<string, unknown>, request });
