...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "update", entityType: "cold-chain-docs", entityId: updated?.id, module: "reefer-container-management", previousData: null, newData: updated as Record<string, unknown>, request });
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "delete", entityType: "cold-chain-docs", entityId: deleted?.id, module: "reefer-container-management", previousData: null, request });
