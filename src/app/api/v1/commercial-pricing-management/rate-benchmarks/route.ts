...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "rate-benchmarks", entityId: created?.id, module: "commercial-pricing-management", newData: created as Record<string, unknown>, request });
