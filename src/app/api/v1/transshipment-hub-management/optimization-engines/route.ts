...
export async function POST(request: NextRequest) {
  try {
    ...
    void logBusinessAudit({ tenantId: user.tenantId, userId: user.id, userEmail: user.email, action: "create", entityType: "optimization-engines", entityId: record?.id, module: "transshipment-hub-management", newData: record as Record<string, unknown>, request });
