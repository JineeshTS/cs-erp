  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Link
          href={`/empty-container-repositioning-ai/cost-trackings/${id}`}
      ...
      <div className="rounded-lg border p-6">
        <EcrForm
          ...
          apiPath={`/api/v1/empty-container-repositioning-ai/cost-trackings/${id}`}
          fields={fields}
          initialData={costTracking}
          isEdit
          returnPath={`/empty-container-repositioning-ai/cost-trackings/${id}`}
        />
      </div>
    </div>
  );
