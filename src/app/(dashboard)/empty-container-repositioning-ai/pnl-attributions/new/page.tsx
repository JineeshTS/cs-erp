...
export default async function NewPnlAttributionPage() {
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Create a new profit and loss attribution record.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-md border p-6">
        <EcrForm
          ...
          fields={fields}
          returnPath="/empty-container-repositioning-ai/pnl-attributions"
        />
      </div>
    </div>
  );
