...
export default async function NewRouteOptimizerPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border p-6">
        <EcrForm
          ...
          apiPath="/api/v1/empty-container-repositioning-ai/route-optimizers"
          fields={fields}
          returnPath="/empty-container-repositioning-ai/route-optimizers"
        />
      </div>
    </div>
  );
