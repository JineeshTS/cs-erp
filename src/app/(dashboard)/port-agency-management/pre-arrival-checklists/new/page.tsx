...
export default async function NewPreArrivalChecklistPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <PamForm
          ...
          apiPath="/api/v1/port-agency-management/pre-arrival-checklists"
          fields={PRE_ARRIVAL_CHECKLIST_FIELDS}
          returnPath="/port-agency-management/pre-arrival-checklists"
        />
      </div>
    </div>
  );
