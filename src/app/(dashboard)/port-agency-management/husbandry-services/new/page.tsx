...
export default async function NewHusbandryServicePage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <PamForm
          ...
          apiPath="/api/v1/port-agency-management/husbandry-services"
          fields={HUSBANDRY_SERVICE_FIELDS}
          returnPath="/port-agency-management/husbandry-services"
        />
      </div>
    </div>
  );
