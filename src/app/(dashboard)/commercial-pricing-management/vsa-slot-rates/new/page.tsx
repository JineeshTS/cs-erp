...
export default async function NewVsaSlotRatePage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-semibold">New VSA Slot Rate</h1>
      </div>

      <CpmForm
        entityType="VSA Slot Rate"
        fields={fields}
        apiPath="/api/v1/commercial-pricing-management/vsa-slot-rates"
