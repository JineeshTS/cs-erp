  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link
          href={`/mobile-operations-app/container-surveys/${id}`}
      ...
      <div className="rounded-lg border bg-white p-6">
        <MobForm
          ...
          apiPath={`/api/v1/mobile-operations-app/container-surveys/${id}`}
          ...
          initialData={{
            ...
            damageCount: record.damageCount ?? "",
            ...
            surveyedAt: record.surveyedAt
              ? record.surveyedAt.toISOString().slice(0, 16)
              : "",
            photoCount: record.photoCount ?? "",
            notes: record.notes ?? "",
          }}
          isEdit
          returnPath={`/mobile-operations-app/container-surveys/${id}`}
        />
      </div>
    </div>
  );
