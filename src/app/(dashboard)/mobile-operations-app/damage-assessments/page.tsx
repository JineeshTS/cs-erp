...
export default async function DamageAssessmentsListPage({
  searchParams,
}: {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Container damage photo upload and AI assessment
          </p>
        </div>
        {canCreate && (
          <Link
            href="/mobile-operations-app/damage-assessments/new"
      ...
      <form method="get" className="flex items-center gap-2">
        <input
          ...
          type="text"
          defaultValue={search}
          placeholder="Search by assessment ref or container..."
      ...
      {data.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          {canCreate && (
            ...
            >
              Create your first damage assessment
            </Link>
          )}
        </div>
      ) : (
              ...
              {data.map((record) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/mobile-operations-app/damage-assessments/${record.id}`}
