...
export default async function NewAgentAssignmentPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-gray-900">New Agent Assignment</h1>
      </div>
      <div className="rounded-lg border bg-white p-6">
        <CsoForm
          entityType="Agent Assignment"
          apiPath="/api/v1/customer-service-operations/agent-assignments"
          fields={AGENT_ASSIGNMENT_FIELDS}
          returnPath="/customer-service-operations/agent-assignments"
        />
      </div>
    </div>
  );
