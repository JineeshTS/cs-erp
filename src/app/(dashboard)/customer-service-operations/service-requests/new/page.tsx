...
export default async function NewServiceRequestPage() {
  ...
  const SERVICE_REQUEST_FIELDS: FieldConfig[] = [
    { name: "requestNumber", label: "Request Number", type: "text", required: true, placeholder: "SR-001" },
    ...
    { name: "subject", label: "Subject", type: "text", required: true, placeholder: "Request subject..." },
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <CsoForm
          ...
          apiPath="/api/v1/customer-service-operations/service-requests"
          fields={SERVICE_REQUEST_FIELDS}
          returnPath="/customer-service-operations/service-requests"
        />
      </div>
    </div>
  );
