...
export default async function SLAPoliciesPage({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/customer-service-operations/sla-policies?${p.toString()}`;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {canCreate && (
          <Link
            href="/customer-service-operations/sla-policies/new"
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          <p className="text-gray-500">No SLA policies found.</p>
          {canCreate && (
            <Link
              href="/customer-service-operations/sla-policies/new"
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/customer-service-operations/sla-policies/${t.id}`}
                      className="font-medium text-gray-900 hover:underline"
                    >
                      {t.policyCode}
                    </Link>
                  </td>
                  <td className="px-4 py-3 text-gray-600">{t.policyName}</td>
