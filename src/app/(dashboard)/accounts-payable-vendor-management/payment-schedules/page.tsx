...
import { Plus, Search, ArrowLeft, Calendar } from "lucide-react";
...
export default async function PaymentSchedulesPage({
  ...
  const { data: items, meta } = await listPaymentSchedules({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/accounts-payable-vendor-management/payment-schedules?${p.toString()}`;
  }
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Manage payment schedules and track execution
            </p>
          </div>
        </div>
        {canCreate && (
          <Link
            href="/accounts-payable-vendor-management/payment-schedules/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Schedule ref, vendor name..."
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          <p className="mt-3 text-gray-500">No payment schedules found.</p>
          {canCreate && (
            <Link
              href="/accounts-payable-vendor-management/payment-schedules/new"
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/accounts-payable-vendor-management/payment-schedules/${t.id}`}
                  ...
                  <td className="px-4 py-3 text-gray-600">
                    {Number(t.paymentAmount).toLocaleString()}
                  </td>
                  <td className="px-4 py-3 text-gray-600">
                    {t.scheduledDate
