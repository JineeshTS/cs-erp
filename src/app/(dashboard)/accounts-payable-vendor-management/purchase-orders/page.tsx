...
export default async function PurchaseOrdersListPage({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/accounts-payable-vendor-management/purchase-orders?${p.toString()}`;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {canCreate && (
          <Link
            href="/accounts-payable-vendor-management/purchase-orders/new"
              ...
              {data.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/accounts-payable-vendor-management/purchase-orders/${t.id}`}
                  ...
                  <td className="px-4 py-3 text-gray-600">{t.poType}</td>
