...
export default async function NewVoyageAnalyticsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold text-gray-900">New Voyage Analytics</h1>
      </div>
      <div className="rounded-lg border bg-white p-6">
        <VrsForm
          entityType="Voyage Analytics"
          apiPath="/api/v1/voyage-results-settlement/voyage-analytics"
          fields={fields}
          returnPath="/voyage-results-settlement/voyage-analytics"
        />
      </div>
    </div>
  );
