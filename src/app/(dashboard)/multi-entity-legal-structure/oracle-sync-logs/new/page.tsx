...
export default async function NewOracleSyncLogPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <MelsForm
          ...
          apiPath="/api/v1/multi-entity-legal-structure/oracle-sync-logs"
          fields={FIELDS}
          returnPath="/multi-entity-legal-structure/oracle-sync-logs"
        />
      </div>
    </div>
  );
