...
export default async function NewIsoCertificationTrackingPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-gray-900">
          New ISO Certification Tracking
        </h1>
      </div>
      <div className="rounded-lg border bg-white p-6">
        <AcmForm
          entityType="ISO Certification Tracking"
          apiPath="/api/v1/audit-compliance-management/iso-certification-trackings"
          fields={fields}
          returnPath="/audit-compliance-management/iso-certification-trackings"
        />
      </div>
    </div>
  );
