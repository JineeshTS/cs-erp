...
export default async function NewSoxFinancialControlPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-gray-900">
          New SOX Financial Control
        </h1>
      </div>
      <div className="rounded-lg border bg-white p-6">
        <AcmForm
          entityType="SOX Control"
          apiPath="/api/v1/audit-compliance-management/sox-financial-controls"
          fields={fields}
          returnPath="/audit-compliance-management/sox-financial-controls"
        />
      </div>
    </div>
  );
