  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link
          href={`/audit-compliance-management/internal-audits/${id}`}
      ...
      <div className="rounded-lg border bg-white p-6">
        <AcmForm
          ...
          apiPath={`/api/v1/audit-compliance-management/internal-audits/${id}`}
          fields={fields}
          initialData={record as Record<string, unknown>}
          isEdit
          returnPath={`/audit-compliance-management/internal-audits/${id}`}
        />
      </div>
    </div>
  );
