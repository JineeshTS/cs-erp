  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link
          href={`/audit-compliance-management/risk-registers/${record.id}`}
      ...
      <div className="rounded-lg border bg-white p-6">
        <AcmForm
          ...
          apiPath={`/api/v1/audit-compliance-management/risk-registers/${record.id}`}
          fields={fields}
          initialData={initialData}
          isEdit
          returnPath={`/audit-compliance-management/risk-registers/${record.id}`}
        />
      </div>
    </div>
  );
