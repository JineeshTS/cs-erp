...
export default async function NewAiRiskDetectionPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-gray-900">
          New AI Risk Detection
        </h1>
      </div>
      <div className="rounded-lg border bg-white p-6">
        <AcmForm
          entityType="AI Risk Detection"
          apiPath="/api/v1/audit-compliance-management/ai-risk-detections"
          fields={fields}
          returnPath="/audit-compliance-management/ai-risk-detections"
        />
      </div>
    </div>
  );
