  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link
          href={`/schedule-voyage-planning/service-schedules/${id}`}
      ...
      <div className="rounded-lg border bg-white p-6">
        <SvpForm
          ...
          apiPath={`/api/v1/schedule-voyage-planning/service-schedules/${id}`}
          ...
          initialData={{
            ...
            publishedAt: record.publishedAt ? record.publishedAt.toISOString().slice(0, 16) : "",
            effectiveFrom: record.effectiveFrom ? record.effectiveFrom.toISOString().slice(0, 16) : "",
            effectiveTo: record.effectiveTo ? record.effectiveTo.toISOString().slice(0, 16) : "",
            notes: record.notes ?? "",
          }}
          isEdit
          returnPath={`/schedule-voyage-planning/service-schedules/${id}`}
        />
      </div>
    </div>
  );
