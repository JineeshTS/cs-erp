...
export default async function DisputesListPage({
  ...
  const { data: disputes, meta } = await listDdmDisputes({
  ...
  function buildNextUrl(nextCursor: string) {
    ...
    return `/demurrage-detention-management/disputes?${p.toString()}`;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {canCreate && (
          <Link
            href="/demurrage-detention-management/disputes/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Dispute ref, customer name..."
      ...
      {disputes.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          <p className="mt-3 text-gray-500">No disputes found.</p>
          {canCreate && (
            <Link
              href="/demurrage-detention-management/disputes/new"
              ...
              {disputes.map((d) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/demurrage-detention-management/disputes/${d.id}`}
                  ...
                  <td className="px-4 py-3 text-gray-600">
                    {formatAmount(d.currency, d.disputedAmount)}
                  </td>
                  <td className="px-4 py-3 text-gray-600">
                    {formatDate(d.filedDate)}
                  </td>
                  <td className="px-4 py-3">
