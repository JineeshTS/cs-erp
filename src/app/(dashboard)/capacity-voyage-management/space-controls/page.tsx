...
export default async function SpaceControlsListPage({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/capacity-voyage-management/space-controls?${p.toString()}`;
  }
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Manage space bookings and container allocations
            </p>
          </div>
        </div>
        {canCreate && (
          <Link
            href="/capacity-voyage-management/space-controls/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Booking reference, shipper, commodity..."
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          <p className="mt-3 text-gray-500">No space controls found.</p>
          {canCreate && (
            <Link
              href="/capacity-voyage-management/space-controls/new"
              className="mt-3 inline-block text-sm text-blue-600 hover:underline"
            >
              Create your first space control
            </Link>
          )}
        </div>
      ) : (
              ...
              {items.map((sc) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/capacity-voyage-management/space-controls/${sc.id}`}
