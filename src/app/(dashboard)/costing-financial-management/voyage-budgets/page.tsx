...
export default async function VoyageBudgetsPage({
  searchParams,
}: {
  ...
  const { data: items, meta } = await listVoyageBudgets({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/costing-financial-management/voyage-budgets?${p.toString()}`;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Voyage Budgets</h1>
          <p className="text-sm text-gray-500">
            Manage voyage budget estimates and actuals
          </p>
        </div>
        {canCreate && (
          <Link
            href="/costing-financial-management/voyage-budgets/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Budget ref, voyage, or vessel..."
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/costing-financial-management/voyage-budgets/${t.id}`}
                  ...
                  <td className="px-4 py-3 text-gray-600">{t.totalBudget}</td>
                  <td className="px-4 py-3">
                    <Badge
                      variant={
                        t.status === "approved"
