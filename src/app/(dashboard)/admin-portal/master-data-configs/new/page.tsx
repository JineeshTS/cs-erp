...
export default async function NewMasterDataConfigPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <AdminForm
          ...
          apiPath="/api/v1/admin-portal/master-data-configs"
          fields={MASTER_DATA_CONFIG_FIELDS}
          returnPath="/admin-portal/master-data-configs"
        />
      </div>
    </div>
  );
