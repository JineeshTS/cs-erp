...
export default async function CrewRotationsListPage({
  searchParams,
}: {
  ...
  const { data: items, meta } = await listCrewRotations({
  ...
  function buildUrl(params: Record<string, string>) {
    ...
    return `/crew-management/crew-rotations?${p.toString()}`;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Crew Rotations</h1>
          <p className="text-sm text-gray-500">
            Manage crew joining, relieving, extensions, and transfers
          </p>
        </div>
        {canCreate && (
          <Link
            href="/crew-management/crew-rotations/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Rotation ref, crew name..."
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/crew-management/crew-rotations/${t.id}`}
