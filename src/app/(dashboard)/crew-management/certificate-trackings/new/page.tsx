...
export default async function NewCertificateTrackingPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <CrmForm
          ...
          apiPath="/api/v1/crew-management/certificate-trackings"
          fields={CERTIFICATE_FIELDS}
          returnPath="/crew-management/certificate-trackings"
        />
      </div>
    </div>
  );
