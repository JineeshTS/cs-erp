  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">New Classification Survey</h1>
          <p className="text-sm text-muted-foreground">
            Create a new classification society survey record
          </p>
        </div>
      </div>
      ...
      <SimForm
        ...
        apiPath="/api/v1/survey-inspection-management/classification-surveys"
        fields={fields}
        returnPath="/survey-inspection-management/classification-surveys"
      />
    </div>
  );
}
