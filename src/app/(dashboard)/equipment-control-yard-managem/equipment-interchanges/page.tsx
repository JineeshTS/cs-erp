...
import { Plus, Search, ArrowLeft, LayoutGrid } from "lucide-react";
...
export default async function EquipmentInterchangesListPage({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/equipment-control-yard-managem/equipment-interchanges?${p.toString()}`;
  }
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Manage equipment interchange receipts
            </p>
          </div>
        </div>
        {canCreate && (
          <Link
            href="/equipment-control-yard-managem/equipment-interchanges/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Interchange reference..."
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          <p className="mt-3 text-gray-500">
            No equipment interchanges found.
          </p>
          {canCreate && (
            <Link
              href="/equipment-control-yard-managem/equipment-interchanges/new"
              ...
              {items.map((ei) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/equipment-control-yard-managem/equipment-interchanges/${ei.id}`}
                  ...
                  <td className="px-4 py-3 text-gray-600">{ei.partyFrom}</td>
                  <td className="px-4 py-3 text-gray-600">{ei.partyTo}</td>
                  <td className="px-4 py-3">
                    <Badge
                      variant={
                        ei.status === "accepted"
