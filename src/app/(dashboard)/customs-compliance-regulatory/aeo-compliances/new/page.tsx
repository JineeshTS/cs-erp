...
export default async function NewAeoCompliancePage(): Promise<React.ReactNode> {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <CcrForm
          ...
          apiPath="/api/v1/customs-compliance-regulatory/aeo-compliances"
          fields={AEO_COMPLIANCE_FIELDS}
          returnPath="/customs-compliance-regulatory/aeo-compliances"
        />
      </div>
    </div>
  );
