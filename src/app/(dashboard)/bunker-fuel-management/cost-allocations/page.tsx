...
export default async function CostAllocationsPage({
  ...
  const { data: items, meta } = await listCostAllocations({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/bunker-fuel-management/cost-allocations?${p.toString()}`;
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Allocate bunker fuel costs across voyages and legs
          </p>
        </div>
        {canCreate && (
          <Link
            href="/bunker-fuel-management/cost-allocations/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Allocation ref, vessel, or voyage..."
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          <p className="mt-3 text-gray-500">No cost allocations found.</p>
          {canCreate && (
            <Link
              href="/bunker-fuel-management/cost-allocations/new"
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/bunker-fuel-management/cost-allocations/${t.id}`}
                  ...
                  <td className="px-4 py-3 text-gray-600">{t.totalCost}</td>
