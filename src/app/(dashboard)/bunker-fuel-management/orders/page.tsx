...
export default async function BunkerOrdersPage({
  searchParams,
}: {
  ...
  const { data: items, meta } = await listBunkerOrders({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/bunker-fuel-management/orders?${p.toString()}`;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Bunker Orders</h1>
          <p className="text-sm text-gray-500">
            Manage bunker fuel procurement orders
          </p>
        </div>
        {canCreate && (
          <Link
            href="/bunker-fuel-management/orders/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Order ref, vessel, or supplier..."
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/bunker-fuel-management/orders/${t.id}`}
