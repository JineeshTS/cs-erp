...
export default async function ProformaEstimateDetailPage({
  params,
}: {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-500">
            Proforma Estimate &middot; {record.vesselName}
          </p>
        </div>
        {canEdit && (
          <Link
            href={`/port-disbursement-accounting/proforma-estimates/${id}/edit`}
      ...
      <div className="rounded-lg border bg-white p-6">
        <dl className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            <dt className="text-sm font-medium text-gray-500">Estimate Ref</dt>
            <dd className="mt-1 text-gray-900">{record.estimateRef}</dd>
          </div>
          <div>
          ...
          <div>
            <dt className="text-sm font-medium text-gray-500">Call Purpose</dt>
            <dd className="mt-1 text-gray-900">{record.callPurpose}</dd>
          </div>
          <div>
          ...
          <div>
            ...
            <dd className="mt-1 text-gray-900">
              {record.estimateDate
                ? new Date(record.estimateDate).toLocaleString()
                : "--"}
            </dd>
          </div>
          <div>
