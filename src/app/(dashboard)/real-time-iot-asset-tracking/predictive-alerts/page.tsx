...
export default async function PredictiveAlertsListPage({
  searchParams,
}: {
  ...
  const conditions = [
    eq(iotPredictiveAlerts.tenantId, session.tenantId),
    isNull(iotPredictiveAlerts.deletedAt),
  ];
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/real-time-iot-asset-tracking/predictive-alerts?${p.toString()}`;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {canCreate && (
          <Link
            href="/real-time-iot-asset-tracking/predictive-alerts/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Alert ref, asset identifier..."
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          <p className="mt-3 text-gray-500">No predictive alerts found.</p>
          {canCreate && (
            <Link
              href="/real-time-iot-asset-tracking/predictive-alerts/new"
              className="mt-3 inline-block text-sm text-blue-600 hover:underline"
            >
              Create your first predictive alert
            </Link>
          )}
        </div>
      ) : (
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/real-time-iot-asset-tracking/predictive-alerts/${t.id}`}
