...
export default async function FreightInvoicesListPage({
  searchParams,
}: {
  ...
  const { data: items, meta } = await listFreightInvoices({
  ...
  function buildUrl(overrides: Record<string, string>) {
    ...
    return `/freight-invoice-revenue-management/freight-invoices?${p.toString()}`;
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage freight invoices, dispatch and track payments
          </p>
        </div>
        {canCreate && (
          <Link
            href="/freight-invoice-revenue-management/freight-invoices/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Invoice number, customer, or B/L..."
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/freight-invoice-revenue-management/freight-invoices/${t.id}`}
                  ...
                  <td className="px-4 py-3">
                    <Badge
                      variant={
                        t.status === "paid"
                          ? "success"
                          : t.status === "overdue" || t.status === "cancelled"
                            ? "destructive"
                            : "secondary"
                      }
                    >
