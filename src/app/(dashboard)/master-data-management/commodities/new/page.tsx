  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Add Commodity</h1>
      </div>

      <div className="rounded-lg border bg-white p-6">
        <MdmForm
          entityType="Commodity"
          apiPath="/api/v1/master-data-management/commodities"
          fields={COMMODITY_FIELDS}
          returnPath="/master-data-management/commodities"
        />
      </div>
    </div>
  );
