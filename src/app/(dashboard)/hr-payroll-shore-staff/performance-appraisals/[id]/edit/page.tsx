  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link
          href={`/hr-payroll-shore-staff/performance-appraisals/${id}`}
      ...
      <div className="rounded-lg border bg-white p-6">
        <HpsForm
          ...
          apiPath={`/api/v1/hr-payroll-shore-staff/performance-appraisals/${id}`}
          fields={fields}
          initialData={record as Record<string, unknown>}
          isEdit
          returnPath={`/hr-payroll-shore-staff/performance-appraisals/${id}`}
        />
      </div>
    </div>
  );
