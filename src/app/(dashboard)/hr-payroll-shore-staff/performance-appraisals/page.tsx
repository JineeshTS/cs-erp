...
import { listPerformanceAppraisals } from "@/lib/hr-payroll-shore-staff/service";
...
export default async function PerformanceAppraisalsPage({
  ...
  const { data: items, meta } = await listPerformanceAppraisals({
  ...
  function buildUrl(params: Record<string, string>) {
    ...
    return `/hr-payroll-shore-staff/performance-appraisals?${p.toString()}`;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {canCreate && (
          <Link
            href="/hr-payroll-shore-staff/performance-appraisals/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Appraisal ref, employee name..."
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          {canCreate && (
            ...
            >
              Create your first performance appraisal
            </Link>
          )}
        </div>
      ) : (
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/hr-payroll-shore-staff/performance-appraisals/${t.id}`}
                  ...
                  <td className="px-4 py-3">
                    {t.overallRating ? (
                      <Badge variant={ratingBadgeVariant(t.overallRating)}>
                        {t.overallRating}
                      </Badge>
                    ) : (
                      "-"
