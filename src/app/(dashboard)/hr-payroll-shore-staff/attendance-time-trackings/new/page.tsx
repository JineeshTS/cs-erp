...
export default async function NewAttendanceTimeTrackingPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-gray-900">
          New Attendance Time Tracking
        </h1>
      </div>
      <div className="rounded-lg border bg-white p-6">
        <HpsForm
          entityType="Attendance Time Tracking"
          apiPath="/api/v1/hr-payroll-shore-staff/attendance-time-trackings"
          fields={fields}
          returnPath="/hr-payroll-shore-staff/attendance-time-trackings"
        />
      </div>
    </div>
  );
