...
export default async function NewReeferBookingPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-gray-900">New Reefer Booking</h1>
      </div>

      <div className="rounded-lg border bg-white p-6">
        <RcmForm
          entityType="Reefer Booking"
          apiPath="/api/v1/reefer-container-management/reefer-bookings"
          fields={BOOKING_FIELDS}
          returnPath="/reefer-container-management/reefer-bookings"
        />
      </div>
    </div>
  );
