...
export default async function NewTempMonitoringPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-gray-900">New Temperature Monitoring</h1>
      </div>

      <div className="rounded-lg border bg-white p-6">
        <RcmForm
          entityType="Temperature Monitoring"
          apiPath="/api/v1/reefer-container-management/temp-monitorings"
          fields={MONITORING_FIELDS}
          returnPath="/reefer-container-management/temp-monitorings"
        />
      </div>
    </div>
  );
