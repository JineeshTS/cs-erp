...
export default async function ChartOfAccountsPage({
  ...
  const { data: items, meta } = await listChartOfAccounts({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/general-ledger-financial-reporting/chart-of-accounts?${p.toString()}`;
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage GL account codes, types, and balances
          </p>
        </div>
        {canCreate && (
          <Link
            href="/general-ledger-financial-reporting/chart-of-accounts/new"
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/general-ledger-financial-reporting/chart-of-accounts/${t.id}`}
