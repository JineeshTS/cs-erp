...
export default async function QuotationLineItemDetailPage({
  params,
}: {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          {canEdit && (
            <Link
              href={`/sales-crm/quotation-line-items/${id}/edit`}
          ...
          {canDelete && (
            <DeleteButton apiPath={`/api/v1/sales-crm/quotation-line-items/${id}`} />
          )}
        </div>
      </div>
      ...
      <div className="rounded-lg border bg-white p-6">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            { label: "Quantity", value: record.quantity.toString() },
            { label: "Total Price", value: record.totalPrice.toLocaleString() },
            ...
            { label: "Mandatory", value: record.isMandatory ? "Yes" : "No" },
          ].map((field) => (
            <div key={field.label}>
