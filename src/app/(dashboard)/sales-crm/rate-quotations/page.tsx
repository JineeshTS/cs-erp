...
export default async function RateQuotationsPage({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/sales-crm/rate-quotations?${p.toString()}`;
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage rate quotations and pricing
          </p>
        </div>
        {canCreate && (
          <Link
            href="/sales-crm/rate-quotations/new"
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          <p className="mt-3 text-gray-500">No quotations found.</p>
          {canCreate && (
            <Link
              href="/sales-crm/rate-quotations/new"
              ...
              {items.map((q) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/sales-crm/rate-quotations/${q.id}`}
                  ...
                  <td className="px-4 py-3 text-gray-600">
                    {new Date(q.validTo).toLocaleDateString()}
                  </td>
                  <td className="px-4 py-3">
                    <Badge
                      variant={
