...
export default async function OpportunityActivitiesPage({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/sales-crm/opportunity-activities?${p.toString()}`;
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Track activities linked to opportunities
          </p>
        </div>
        {canCreate && (
          <Link
            href={`/sales-crm/opportunity-activities/new${opportunityId ? `?opportunityId=${opportunityId}` : ""}`}
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          <p className="mt-3 text-gray-500">No activities found.</p>
          {canCreate && (
            <Link
              href="/sales-crm/opportunity-activities/new"
              ...
              {items.map((a) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/sales-crm/opportunity-activities/${a.id}`}
