...
export default async function NewDocPermitPage(): Promise<React.ReactNode> {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <OogForm
          ...
          apiPath="/api/v1/oog-special-cargo-management/doc-permits"
          fields={DOC_PERMIT_FIELDS}
          returnPath="/oog-special-cargo-management/doc-permits"
        />
      </div>
    </div>
  );
