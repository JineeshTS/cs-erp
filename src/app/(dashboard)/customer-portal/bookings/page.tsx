...
export default async function BookingsListPage({
  ...
  const { data: items, meta } = await listBookings({
  ...
  function buildNextUrl(nextCursor: string) {
    ...
    return `/customer-portal/bookings?${p.toString()}`;
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage customer portal bookings
          </p>
        </div>
        {canCreate && (
          <Link
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Booking ref or customer name..."
              ...
              {items.map((t) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/customer-portal/bookings/${t.id}`}
