...
const MANIFEST_ITEM_FIELDS: FieldConfig[] = [
  { name: "manifestId", label: "Manifest ID", type: "text", required: true },
...
export default async function NewManifestItemPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <OdmForm
          ...
          apiPath="/api/v1/operations-documentation/manifest-items"
          fields={MANIFEST_ITEM_FIELDS}
          returnPath="/operations-documentation/manifest-items"
        />
      </div>
    </div>
  );
