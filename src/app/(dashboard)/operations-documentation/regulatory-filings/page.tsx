...
export default async function RegulatoryFilingsPage({
  searchParams,
}: {
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/operations-documentation/regulatory-filings?${p.toString()}`;
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage AMS, ISF, ICS2, and other regulatory filings
          </p>
        </div>
        {canCreate && (
          <Link
            href="/operations-documentation/regulatory-filings/new"
        ...
        <div className="min-w-[200px] flex-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search}
              placeholder="Search by filing reference..."
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          <p className="mt-3 text-gray-500">No regulatory filings found.</p>
          {canCreate && (
            <Link
              href="/operations-documentation/regulatory-filings/new"
              ...
              {items.map((filing) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/operations-documentation/regulatory-filings/${filing.id}`}
