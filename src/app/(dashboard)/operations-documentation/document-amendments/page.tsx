...
export default async function DocumentAmendmentsListPage({
  ...
  function buildNextUrl(nextCur: string) {
    ...
    return `/operations-documentation/document-amendments?${p.toString()}`;
  }
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Manage amendment requests for bills of lading
            </p>
          </div>
        </div>
        {canCreate && (
          <Link
            href="/operations-documentation/document-amendments/new"
      ...
      {items.length === 0 ? (
        <div className="rounded-lg border bg-white px-8 py-12 text-center">
          ...
          <p className="mt-3 text-gray-500">No document amendments found.</p>
          {canCreate && (
            <Link
              href="/operations-documentation/document-amendments/new"
              ...
              {items.map((a) => (
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      href={`/operations-documentation/document-amendments/${a.id}`}
                  ...
                  <td className="px-4 py-3 text-gray-600">
                    {(a.oldValue ?? "-").slice(0, 30)}
                  </td>
                  <td className="px-4 py-3 text-gray-600">
                    {(a.newValue ?? "-").slice(0, 30)}
                  </td>
                  <td className="px-4 py-3">
                    <Badge
                      variant={
