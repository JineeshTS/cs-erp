...
export default async function SparePartsPage({
  ...
  const { data: items, meta } = await listSpareParts({
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {canCreate && (
          <Link
            href="/vessel-technical-management/spare-parts/new"
        ...
        <div className="flex-1 min-w-[200px]">
          ...
          <div className="relative">
            ...
            <input
              ...
              type="text"
              defaultValue={search ?? ""}
              placeholder="Search by ref or part name..."
        ...
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-300 py-16 dark:border-gray-600">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            {search || status
              ...
              : "Get started by creating a new spare part."}
          </p>
              ...
              {items.map((sp) => (
                ...
                >
                  <td className="whitespace-nowrap px-4 py-3 text-sm">
                    <Link
                      href={`/vessel-technical-management/spare-parts/${sp.id}`}
      ...
      <div className="flex items-center justify-between">
        ...
        {nextCursor && (
          <Link
            href={{
              pathname: "/vessel-technical-management/spare-parts",
              query: {
                ...(search ? { search } : {}),
                ...(status ? { status } : {}),
                cursor: nextCursor,
