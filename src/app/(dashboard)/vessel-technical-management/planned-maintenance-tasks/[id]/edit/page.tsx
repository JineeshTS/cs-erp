...
export default async function EditPlannedMaintenanceTaskPage({
  params,
}: {
  ...
  return (
    <div className="space-y-6">
      ...
      <VtmForm
        ...
        apiPath={`/api/v1/vessel-technical-management/planned-maintenance-tasks/${id}`}
        fields={fields}
        initialData={record as unknown as Record<string, unknown>}
        isEdit
        returnPath={`/vessel-technical-management/planned-maintenance-tasks/${id}`}
      />
    </div>
  );
}
