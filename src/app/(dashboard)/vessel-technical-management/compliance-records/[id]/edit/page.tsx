  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Link
          href={`/vessel-technical-management/compliance-records/${record.id}`}
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
        <VtmForm
          ...
          apiPath={`/api/v1/vessel-technical-management/compliance-records/${record.id}`}
          fields={fields}
          initialData={record as unknown as Record<string, unknown>}
          isEdit
          returnPath={`/vessel-technical-management/compliance-records/${record.id}`}
        />
      </div>
    </div>
  );
