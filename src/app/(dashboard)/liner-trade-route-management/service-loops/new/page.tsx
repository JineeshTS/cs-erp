...
export default async function NewServiceLoopPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <LtrForm
          ...
          apiPath="/api/v1/liner-trade-route-management/service-loops"
          fields={SERVICE_LOOP_FIELDS}
          returnPath="/liner-trade-route-management/service-loops"
        />
      </div>
    </div>
  );
