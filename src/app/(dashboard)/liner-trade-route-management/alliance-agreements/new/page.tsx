...
export default async function NewAllianceAgreementPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6">
        <LtrForm
          ...
          apiPath="/api/v1/liner-trade-route-management/alliance-agreements"
          fields={ALLIANCE_AGREEMENT_FIELDS}
          initialData={{ memberCarriers: [] }}
          returnPath="/liner-trade-route-management/alliance-agreements"
        />
      </div>
    </div>
  );
